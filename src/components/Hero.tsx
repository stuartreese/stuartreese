  ...
  return (
    <section ref={wrap} className="relative isolate overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <p className="reveal inline-flex items-center gap-2 rounded-full border border-sand bg-parchment/70 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-forest">
          ...
          <h1 className="display mt-6 text-5xl leading-[0.95] sm:text-7xl lg:text-[5.6rem]">
            Hi, I&rsquo;m{" "}
            <span className="display-italic text-forest">{site.firstName}</span>.
          </h1>
          ...
          <ul className="mt-6 flex flex-wrap gap-2" aria-label="Three words that describe me">
            {words.map((w, i) => (
              <li
                key={w}
                className="reveal rounded-full bg-forest px-4 py-1.5 text-sm font-medium text-cream shadow-soft"
          ...
          <div className="reveal mt-9 flex flex-wrap items-center gap-3" style={{ "--reveal-delay": "420ms" } as React.CSSProperties}>
            <a
              href="#work"
              className="inline-flex items-center gap-2 rounded-full bg-ink px-5 py-3 text-sm font-medium text-cream shadow-soft transition hover:-translate-y-0.5 hover:bg-pine"
            >
              See the work
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border border-ink/20 bg-cream/60 px-5 py-3 text-sm font-medium transition hover:border-ink/50 hover:-translate-y-0.5"
            >
              Say hello
            </a>
          </div>
        ...
        <div className="relative mx-auto w-full max-w-sm lg:max-w-md">
          ...
          >
            ...
            <div className="absolute -inset-1 -z-10 rounded-[52%_48%_46%_54%/44%_52%_48%_56%] bg-forest" />
            ...
            <span className="display-italic absolute -bottom-3 -left-3 rotate-[-6deg] rounded-full border border-sand bg-cream px-3 py-1 text-sm text-forest shadow-soft sm:-left-6">
              nice to meet you
            </span>
          </div>
        </div>
